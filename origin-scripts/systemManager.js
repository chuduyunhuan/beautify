...
var systemManager = {
	     ...
	     getDiv : function(i){
	          ...
	          $("div[id*='div_']").html("");
	          var divHeight = k*0.97; var tableHeight = k*0.97*0.99;
           // if(i == 0){
          ...
          if(treeId.indexOf("0")>-1){
                $('#'+treeId).treegrid({
                       ...
                       {field:'role', formatter:function(value,rowData,rowIndex){
                                      ...
                                      },title:'角色/用户名',width:240},
                       {field:'name',title:'姓名',width:80,align:'center'},        
                       {field:'dept',title:'部门',width:120,align:'center'},       
	     ...
	     initRepoprtTree : function(treeId,flag){
          ...
          if (treeId.indexOf("1")>-1) {
                 $('#'+treeId).treegrid({
                        ...
                        columns:[[
                        {field:'name', formatter:function(value,rowData,rowIndex){
                                        if(rowData.type == 0){curr_role = rowData.id;}; 
                                        if(rowData.type == 0){
                                          return rowData.name;
                                        }else{
       ...
       selectCurrUserOfReport : function(obj){
                 ...
                 if(res.success){
                     ...
                     for(var i=0;i<dataArr.length;i++){
                           ...
                           var currObj = {"id":$('#'+reportid).attr("id"),
       ...
       selctAllFuncUp_U : function(owner){
	     ...
	     save : function(){
              ...
              if(reportCheckedArr.length == 0){alert("请选择报表!");return;}; 
              if(userCheckedArr.length == 0){alert("请选择用户!");return;}; 
