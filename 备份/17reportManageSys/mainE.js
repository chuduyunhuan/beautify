...
var mainE = {
           ...
           initDataPool : function(){
                     var data ={"ifId":"srpt-enum-dataSource"};
           ...
           zhuanhuancaidanData : function(data){  //data  To   arr
                     ...
                     for(var i=0;i<data.length;i++){
                           ...
                           if(type ==0){
                              ...
                              //-------------------
                               obj.state="closed";
                               obj.attributes={"ishasChilds":true};
                             arr.push(obj);
                           };
                     };
                     //-------------------------------
                            for(var i=0;i<data.length;i++){
                                  ...
                                  var obj={};
                                   ...
                                   if(type ==1){
                                      ...
                                      obj.attributes={"ishasChilds":false};
                                  arr.push(obj);
                                  };
                            };
                     //-------------------------------
           ...
           loadTree : function(){
                     ...
                     $('#tree').tree({
                         ...
                         onBeforeDrop :function(target,source,point){
                                  ...
                                  //判断新目标是否可放入
                                  var dataT = {"ifId":"srpt-cfg-menuQueryself",
                                              "id":targetId};
                         ...
                         onBeforeExpand:function(node){
                          if(isRelExplan){return; }
                             ...
                             for(var i=0;i<childrens.length;i++){
                              ...
                              $('#tree').tree("append",{parent:parent.target,data:arr});  
                         },
           ...
           alterReportNames : function(){
                             ...
                             if(name_ == "" ||name_.trim() == ""){alert("名称不能为空!");return;}; 
                             var flag = mainE.checkUpdateMenueName(name_); 
                             if(flag == 1){alert("该名称已存在!");return;}; 
                             var data = {
                                          "dbId":"srpt",
                                          "tableName":configUrl_main.dm_co_ba_srpt_menu_tableName,
                                          //"tableName":"dm_co_ba_srpt_menu",
           ...
           addDataSource : function(){
                     ...
                     if(dataName.trim() ==""){alert("名称不能为空!");return;};
                     //校验数据源名称是否已经存在--------------

                         var dataB = {"ifId":"srpt-enum-dataSource"};
                        ...
                        if(ifExist ==1){alert("该名称已存在!");return;};    
                     //----------------------------------------
                     var data = {
                                 "dbId":"srpt",
                   ...
                   //alert(param);
                    for (var i = 0; i < field_arith_arr.length; i++) {
                             if (param == field_arith_arr[i].name) {
                                   ...
                                   if (strategy_arr == null || strategy_arr == "null") {return;};
          ...
          addMuluName : function(){
           ...
           checkCreateMenueName : function(name){
                            ...
                            var nodeId = $("#mmTtr").html();
                            var data = {"ifId":"srpt-cfg-menuQuery",
                                         //"parent_id":nodeId
                                         "parent_id":""
                                        };
                            var dataStr = JSON.stringify(data);  
                            ...
                            for(var i=0;i<resultMenueNameArr.length;i++){
                                  if (resultMenueNameArr[i] == name) {flag = 1;};
                            };
                            return flag;
           ...
           checkUpdateMenueName : function(name){
                           ...
                           //查询父类id 
                           var dataC = {"ifId":"srpt-cfg-menuQueryParent",
