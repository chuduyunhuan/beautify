    ...
    var reportQueryResult ={
                       ...
                       /*queryReportLieWidth : function(){
    	                 ...
    	                 getReportResultData : function(flaga){
                                         ...
                                         if (fromWhere == "autoReportId") {val = parent.autoReport.showQueryReportResultData();};
                                         if (fromWhere == "mainE") {val = parent.mainE.showQueryReportResultData();};
                                         if (fromWhere == "myReport") {val = parent.myReport.showQueryReportResultData();}; 
                                         if (fromWhere == "reportQuery") {val = parent.reportQuery.showQueryReportResultData();};
                                                ...
                                                //不着色
                                                     for(var i=0;i<sorted_field_info_all.length;i++){
                                                             ...
                                                             if(currObject.fieldname == "地市"){
                                                                  var obj = {name:'',index:'', width:80,align:"center"};
                                                                 ...
                                                                 var obj = {name:'',index:'', width:130,align:"center"};
                                                                  obj.name=currObject.fieldname;
                                                                  obj.index=currObject.fieldname;
                                                                  if(currObject.linewidth != 0){
                                                                         obj.width=currObject.linewidth;
                                                             ...
                                                             for (var j = 0; j < curryReportAddRuleArr.length; j++) {
                                                                  var item = curryReportAddRuleArr[j];
                                                                   ...
                                                                   for(var k=0;k<curryReportAddRuleArr.length;k++){
                                                                       if( currName == curryReportAddRuleArr[k].field ){ mm_z++;};
                                                                   }; 
                                                                  ...
                                                                  if(currName == item.field){   //判断着色字段
                                                                             ...
                                                                             if(item.type == 1){     //区间着色
                                                                               var obj = {name:columnsNameNew[i],index:columnsNameNew[i], width:120,align:"center",formatter:function(cellVal,options,rowObjs){
                                                                          ...
                                                                          if(mm_z == 0){
                                                                          var obj = {name:'',index:'', width:140,align:"center"};
                       ...
                       addColorDemo : function(val,index){
                                  ...
                                  var columnsConfig = [
                                                       ...
                                                       ,{name:'type',index:'type', width:25,align:"center",formatter:function(cellVal,options,rowObjs){
                                                                            switch(cellVal){
                                                                                 case '0' :
                                                                                     return "枚举";break;
                                                                                 case '1' :
                                                       ...
                                                       ,{name:'strategy',index:'strategy', width:80,align:"center"}
                                     ];
                                        //初始化表格
                                        ...
                                        $("#con_grid_div_grid_d").jqGrid({
                                            ...
                                            var data = {"ifId":"srpt-enum-colorCfg","type":addDemoType};
                                            var dataStr = JSON.stringify(data);
                       ...
                       addColorDemos : function(){
                                      if(select_id == ""){alert("请选择模板!");return;}; 
                       ...
                       addColorDemoDetail : function(){
                                  ...
                                  switch(type){
                                      case "区间" :
                                             reportQueryResult.addColorDemoDetail_qujian(id,name,type,strategy);break;
                                      case "枚举" :
                                             reportQueryResult.addColorDemoDetail_meiju(id,name,type,strategy);break;
                       ...
                       seekFieldArith : function(){
                                           ...
                                           var columnsConfig_field = [
                                                                ...
                                                                ,{name:'DESCR_',index:'DESCR_', width:120,align:"center",formatter:function(cellVal,options,rowObjs){
                                                                          return  cellVal == null?"--":cellVal ; 
                                                                    } 
                                                                  }
                                                                ,{name:'STRATEGY',index:'STRATEGY', width:120,align:"center",formatter:function(cellVal,options,rowObjs){
                                                                                 var ces = cellVal; 
                                                                                 if(typeof(cellVal) != "string"){ces = JSON.stringify(cellVal);};
