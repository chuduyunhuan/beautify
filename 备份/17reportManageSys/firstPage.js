...
var firstPage = {
	         ...
	         AD_scrData : function(){
	        	 ...
	        	 var data ={"ifId":"srpt-cfg-homePageAffiche"};
           ...
           //      $("#AD_scroll").mask("加载中...");
	         ...
	         see_countData: function(){
	        	 ...
	        	 //var url="/srpt/rcpt/common/query";
	        	 var data={"ifId":"srpt-cfg-homePageUserQueryTopTen"};
	        	 var dataStr = JSON.stringify(data);
	        //	 $("#see_count").mask("加载中...");
	        	 var res=commonAjax(url,dataStr,"","");
				       if(!res.success){
	         ...
	         pre_see_countData : function(){
	        	 ...
	        	 //var url="/srpt/rcpt/common/query";
	        	 var data={"ifId":"srpt-cfg-homePageCurrentUserRptTopTen",
	        	           "username" : userName
	        	          };
	        	 var dataStr = JSON.stringify(data);
	        //	 $("#pre_see_count").mask("加载中...");
	         ...
	         table_countData : function(){
	        	 ...
	        	 //var url="/srpt/rcpt/common/query";
	        	 var data={"ifId":"srpt-cfg-homePageReportCntTend"};
	        	 var dataStr= JSON.stringify(data);
	        //	 $("#table_count").mask("加载中...");
	         ...
	         visit_countData : function(){
	        	 ...
	        	 //var url="/srpt/rcpt/common/query";
	        	 var data={"ifId":"srpt-cfg-homePageQueryRptAreaTopTen"};
	        	 var dataStr= JSON.stringify(data);
	        //	 $("#visit_count").mask("加载中...");
	         ...
	         user_T_countData : function(){
	        	 ...
	        	 //var url="/srpt/rcpt/common/query";
	        	 var data={"ifId":"srpt-cfg-homePageUserCntRptCntTopTen"};
	        	 var dataStr= JSON.stringify(data);
...
//----饼图按钮切换----------
function pT(obj,bt){
  	$(bt).css({'border-top':'3px solid blue','border-bottom':'0'});
  	$(bt).siblings().css({'border-top':'','border-bottom':''});
	var obj=$("#"+obj);
 ...
 function listData(){
     ...
     var columnsConfig =[{name:'reportName',index:'reportName', width:150,align:"center",sortable:false},
                            {name:'username',index:'username', width:120,align:"center" ,sortable:false},
                            {name:'fullname',index:'fullname', width:100,align:"center" ,sortable:false},
                            {name:'deptname',index:'deptname', width:170,align:"center" ,sortable:false},
                            {name:'lasttime',index:'lasttime', width:150,align:"center" ,sortable:false}
   ];
